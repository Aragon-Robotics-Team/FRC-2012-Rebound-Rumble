...
#define THETA 13.5 // value of camera angle (half of FOV)
...
public:
	...
	float SoftStart(float current, float target, float limit = 1.0, float max = MAX_SPEED)
	{
		float result = target;
	...
	{		
		...
		turretMotor->Set(MAX_SPEED * position);
